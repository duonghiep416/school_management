                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" >
                                    ...
                                    <input type ="text" class="form-control" required name="marital_status" value="{{ old('marital_status') }}" placeholder="Marital Status">
                                ...
                                <div class="form-group col-md-6" >
                                    ...
                                    <input type ="text" class="form-control" name="address" value="{{ old('address') }}"  placeholder="Current Address">
